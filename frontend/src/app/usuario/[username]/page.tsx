        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 min-w-0">
          ...
          <div className="flex-1">
            ...
            {profile?.isBetaTester && (
              <span className="inline-flex mt-1 rounded-full border border-rose-300/40 bg-rose-100/70 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-zinc-800 dark:border-rose-700/40 dark:bg-rose-900/30 dark:text-zinc-300">
                beta_tester
              </span>
            )}
            {profile?.location && (
