        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 min-w-0">
          ...
          <div className="flex-1">
            ...
            {profile?.isBetaTester && (
              <span className="inline-flex mt-1 rounded-full border border-[var(--border)] bg-[var(--surface-2)] px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[var(--foreground)]">
                beta_tester
              </span>
            )}
            {profile?.location && (
